...
import core.engine
from interfaces.telegram_bot import send_message, ADMIN_CHAT_ID
    ...
    while True:
        try:
            ...
            curiosity_prompt = (
                ...
                "e investiga en la red formas de optimizar tu lógica. "
            ...
            if ADMIN_CHAT_ID and result.get('message'):
                send_message(ADMIN_CHAT_ID, f"🧠 *LOG DE CURIOSIDAD*\n\n{result['message']}")
